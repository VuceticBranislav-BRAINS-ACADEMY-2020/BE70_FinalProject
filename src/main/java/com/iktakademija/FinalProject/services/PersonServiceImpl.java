...
public class PersonServiceImpl implements PersonService {
	...
	public PersonDTO setPerson(Integer personId, NewPersonDTO newPerson) {			
		...
		if (newPerson.getAddress() != null) person.setAddress(address);  // TODO FIx this
		if (newPerson.getBirthdate() != null)person.setBirthdate(newPerson.getBirthdate());
		if (newPerson.getFirstname() != null)person.setFirstname(newPerson.getFirstname());
		if (newPerson.getJmbg() != null)person.setJmbg(newPerson.getJmbg());	
		if (newPerson.getLastname() != null)person.setLastname(newPerson.getLastname());
		if (newPerson.getMphone() != null)person.setMphone(newPerson.getMphone());	
