...
//			Optional<TeacherEntity> op3 = teacherRepository.findById(teacherId);
//			if (op3.isPresent())
//				teacher = op3.get();
//		}
//
...
//			Optional<GroupEntity> op4 = groupRepository.findById(groupId);
//			if (op4.isPresent())
//				group = op4.get();
//		}
//
...
//			Optional<ClassEntity> op5 = classRepository.findById(classId);
//			if (op5.isPresent())
//				clazz = op5.get();
//		}
//
