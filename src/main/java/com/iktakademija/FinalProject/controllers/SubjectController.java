...
/**
 * Subject endpoint. <BR>
 * Provide all subject functionalities.
 */
@RestController
...
public class SubjectController {
	...
	/**
	 * REST endpoint that returns subjects from data base by id. Method always
	 * return {@link HttpStatus.OK} if there is no internal error.<BR>
	 * 
	...
	public ResponseEntity<?> addSubject(@Valid @RequestBody NewSubjectDTO newSubject) {
	...
	public ResponseEntity<?> setSubject(@PathVariable(value = "id") Integer subjectId,
			@RequestBody NewSubjectDTO newSubject) {
